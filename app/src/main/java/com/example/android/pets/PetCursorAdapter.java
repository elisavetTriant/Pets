...
public class PetCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String petName = cursor.getString(cursor.getColumnIndexOrThrow(PetContract.PetsEntry.COLUMN_PET_NAME));
        String petBreed = cursor.getString(cursor.getColumnIndexOrThrow(PetContract.PetsEntry.COLUMN_PET_BREED));
