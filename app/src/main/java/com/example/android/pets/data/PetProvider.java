...
public class PetProvider extends ContentProvider {
    ...
    /**
     * URI matcher code for the content URI for the pets table (all records)
     */
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case PETS:
                ...
                // TODO: Perform database query on pets table - select all rows
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        //Check that the gender is not null and is valid gender type
